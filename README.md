...
기술의 화려함이나 무비판적 도입하지 않습니다.  
"이 방법이 최선일까?"라는 본질적인 질문에서 출발하는 실용주의 백엔드 개발자입니다.    
대규모 트래픽과 동시성 이슈를 다루기 위해 Redisson 분산 락, Kafka/RabbitMQ 기반의 이벤트 기반 통신 구조를 설계하며 시스템의 병목을 객관적인 지표로 개선했고, 문제를 풀어가는 과정을 즐깁니다.  
